...
export const UNEP_AREA_DEFINITIONS: Record<UnepSearchArea, UnepAreaDefinition> =
  {
    ...
    montauban: createDepartmentCityArea({
      regionId: UNEP_REGION_OCCITANIE,
      regionName: "Occitanie",
      areaName: "Montauban",
      cityName: "MONTAUBAN",
    ...
    arles: createDepartmentCityArea({
      regionId: UNEP_REGION_PACA,
      regionName: "Provence-Alpes-Côte d'Azur",
      areaName: "Arles",
      cityName: "ARLES",
      departmentPrefix: "13",
      approximateCount: 336,
      metroLabel: "Inclure les Bouches-du-Rhône (13)",
    }),
    "salon-de-provence": createDepartmentCityArea({
      regionId: UNEP_REGION_PACA,
      regionName: "Provence-Alpes-Côte d'Azur",
      areaName: "Salon-de-Provence",
      cityName: "SALON DE PROVENCE",
      departmentPrefix: "13",
      approximateCount: 336,
      metroLabel: "Inclure les Bouches-du-Rhône (13)",
    }),
    frejus: createDepartmentCityArea({
      regionId: UNEP_REGION_PACA,
      regionName: "Provence-Alpes-Côte d'Azur",
      areaName: "Fréjus",
      cityName: "FREJUS",
      departmentPrefix: "83",
      approximateCount: 336,
      metroLabel: "Inclure le Var (83)",
    }),
    hyeres: createDepartmentCityArea({
      regionId: UNEP_REGION_PACA,
      regionName: "Provence-Alpes-Côte d'Azur",
      areaName: "Hyères",
      cityName: "HYERES",
    ...
    grasse: createDepartmentCityArea({
      regionId: UNEP_REGION_PACA,
      regionName: "Provence-Alpes-Côte d'Azur",
      areaName: "Grasse",
      cityName: "GRASSE",
    ...
    "saint-malo": createDepartmentCityArea({
      regionId: UNEP_REGION_BRETAGNE,
      regionName: "Bretagne",
      areaName: "Saint-Malo",
      cityName: "SAINT MALO",
      departmentPrefix: "35",
      approximateCount: 400,
      metroLabel: "Inclure l'Ille-et-Vilaine (35)",
    }),
    cholet: createDepartmentCityArea({
      regionId: UNEP_REGION_PAYS_DE_LA_LOIRE,
      regionName: "Pays de la Loire",
      areaName: "Cholet",
      cityName: "CHOLET",
      departmentPrefix: "49",
      approximateCount: 407,
      metroLabel: "Inclure le Maine-et-Loire (49)",
    }),
    saumur: createDepartmentCityArea({
      regionId: UNEP_REGION_PAYS_DE_LA_LOIRE,
      regionName: "Pays de la Loire",
      areaName: "Saumur",
      cityName: "SAUMUR",
    ...
    laval: createDepartmentCityArea({
      regionId: UNEP_REGION_PAYS_DE_LA_LOIRE,
      regionName: "Pays de la Loire",
      areaName: "Laval",
      cityName: "LAVAL",
    ...
    vichy: createDepartmentCityArea({
      regionId: UNEP_REGION_AUVERGNE_RHONE_ALPES,
      regionName: "Auvergne-Rhône-Alpes",
      areaName: "Vichy",
      cityName: "VICHY",
    ...
    moulins: createDepartmentCityArea({
      regionId: UNEP_REGION_AUVERGNE_RHONE_ALPES,
      regionName: "Auvergne-Rhône-Alpes",
      areaName: "Moulins",
      cityName: "MOULINS",
      departmentPrefix: "03",
      approximateCount: 468,
      metroLabel: "Inclure l'Allier (03)",
    }),
    aurillac: createDepartmentCityArea({
      regionId: UNEP_REGION_AUVERGNE_RHONE_ALPES,
      regionName: "Auvergne-Rhône-Alpes",
      areaName: "Aurillac",
      cityName: "AURILLAC",
    ...
    montelimar: createDepartmentCityArea({
      regionId: UNEP_REGION_AUVERGNE_RHONE_ALPES,
      regionName: "Auvergne-Rhône-Alpes",
      areaName: "Montélimar",
      cityName: "MONTELIMAR",
      departmentPrefix: "26",
      approximateCount: 468,
      metroLabel: "Inclure la Drôme (26)",
    }),
    libourne: createDepartmentCityArea({
      regionId: UNEP_REGION_NOUVELLE_AQUITAINE,
      regionName: "Nouvelle-Aquitaine",
      areaName: "Libourne",
      cityName: "LIBOURNE",
      departmentPrefix: "33",
      approximateCount: 490,
      metroLabel: "Inclure la Gironde (33)",
    }),
    bergerac: createDepartmentCityArea({
      regionId: UNEP_REGION_NOUVELLE_AQUITAINE,
      regionName: "Nouvelle-Aquitaine",
      areaName: "Bergerac",
      cityName: "BERGERAC",
      departmentPrefix: "24",
      approximateCount: 490,
      metroLabel: "Inclure la Dordogne (24)",
    }),
    "mont-de-marsan": createDepartmentCityArea({
      regionId: UNEP_REGION_NOUVELLE_AQUITAINE,
      regionName: "Nouvelle-Aquitaine",
      areaName: "Mont-de-Marsan",
      cityName: "MONT DE MARSAN",
      departmentPrefix: "40",
      approximateCount: 490,
    }),
    narbonne: createDepartmentCityArea({
      regionId: UNEP_REGION_OCCITANIE,
      regionName: "Occitanie",
      areaName: "Narbonne",
      cityName: "NARBONNE",
      departmentPrefix: "11",
      approximateCount: 378,
      metroLabel: "Inclure l'Aude (11)",
    }),
    mende: createDepartmentCityArea({
      regionId: UNEP_REGION_OCCITANIE,
      regionName: "Occitanie",
      areaName: "Mende",
      cityName: "MENDE",
    ...
    epinal: createDepartmentCityArea({
      regionId: UNEP_REGION_GRAND_EST,
      regionName: "Grand Est",
      areaName: "Épinal",
      cityName: "EPINAL",
    ...
    arras: createDepartmentCityArea({
      regionId: UNEP_REGION_GRAND_EST,
      regionName: "Grand Est",
      areaName: "Arras",
      cityName: "ARRAS",
      departmentPrefix: "62",
      approximateCount: 301,
      metroLabel: "Inclure le Pas-de-Calais (62)",
    }),
    valenciennes: createDepartmentCityArea({
      regionId: UNEP_REGION_GRAND_EST,
      regionName: "Grand Est",
      areaName: "Valenciennes",
      cityName: "VALENCIENNES",
      departmentPrefix: "59",
      approximateCount: 301,
      metroLabel: "Inclure le Nord (59)",
    }),
    belfort: createDepartmentCityArea({
      regionId: UNEP_REGION_GRAND_EST,
      regionName: "Grand Est",
      areaName: "Belfort",
      cityName: "BELFORT",
    ...
    thionville: createDepartmentCityArea({
      regionId: UNEP_REGION_GRAND_EST,
      regionName: "Grand Est",
      areaName: "Thionville",
      cityName: "THIONVILLE",
      departmentPrefix: "57",
      approximateCount: 301,
      metroLabel: "Inclure la Moselle (57)",
    }),
    biarritz: createDepartmentCityArea({
      regionId: UNEP_REGION_NOUVELLE_AQUITAINE,
      regionName: "Nouvelle-Aquitaine",
      areaName: "Biarritz",
      cityName: "BIARRITZ",
